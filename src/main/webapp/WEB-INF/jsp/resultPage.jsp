				...
				<c:if test="${not empty arpenp }">
					...
					<div align="left" style="width: 100%; height: 100%">
						...
						<label>Nome Conjuge : ${arpenp.conjuge} </label> <br> <label>Novo
							...
							${arpenp.dtEntrada} </label> <br> <label>Data do Registro :
							${arpenp.dtRegistro} </label> <br> <label>Acervo :
				...
				<c:if test="${not empty caged}">
					...
					<div align="left" style="width: 100%; height: 100%">
						...
						<c:if test="${not empty caged.cagedEmpresa}">
							...
							<br>
							<label>Razao Social : ${caged.cagedEmpresa.razaoSocial} </label>
							<br>
							...
							<br>
							<label>Primeiro Dia : ${caged.cagedEmpresa.primeiroDia} </label>
							<br>
				...
				<c:if test="${not empty censec}">
					...
					<div align="left" style="width: 100%; height: 100%">
						<label>Carga : ${censec.carga} </label> <br> <label>Data
							...
							${censec.dtAto} </label> <br> <label>Livro : ${censec.livro}
						</label> <br> <label>Complemento : ${censec.complemento} </label> <br>
						<label>Folha : ${censec.folha} </label> <br> <label>Nome
							: ${censec.nome} </label> <br> <label>CNPJ :
							${censec.cpfCnpj} </label> <br> <label>Qualidade :
							${censec.qualidade} </label> <br> <label>Telefone :
							${censec.telefone} </label> <br> <label>Tipo :
							${censec.tipo} </label> <br> <label>Ramal : ${censec.ramal}
				...
				<c:if test="${not empty jucespList}">
					...
					<div align="left" style="width: 100%; height: 100%">
						<c:forEach items="${jucespList}" var="jucesp">
							...
							<br>
							<label>Inicio da Atividade : ${jucesp.inicioAtividade} </label>
							<br>
							<label>CNPJ : ${jucesp.cnpj} </label>
							<br>
							<label>Inscricao Estadual : ${jucesp.incricaoEstadual} </label>
							<br>
				...
				<c:if test="${not empty sivec}">
					...
					<div align="left" style="width: 100%; height: 100%">
						...
						<label>Tipo de RG : ${sivec.tipoRg} </label> <br> <label>Data
							...
							${sivec.formulaFundamental} </label> <br> <label>Posto de
							Identificacao : ${sivec.postoIdentificacao} </label> <br> <label>Alcunha
							: ${sivec.alcunha} </label> <br> <label>Endereco Residencial
							: ${sivec.residencial} </label> <br> <label>Endereco
							Trabalho : ${sivec.trabalho} </label> <br> <label>Nome
							Outros : ${sivec.nomeOutros} </label> <br> <label>RG Outros
							: ${sivec.rgOutros} </label> <br> <label>Data de Nacimento
				...
				<c:if test="${not empty sivecList}">
					...
					<div align="left" style="width: 100%; height: 100%">
						<c:forEach items="${sivecList}" var="sivec">
							...
							<br>
							<label>Formula Fundamental : ${sivec.formulaFundamental}
							</label>
							<br>
