				...
				<div>
					...
					<c:if test="${not empty censec}">
						...
						<div align="left" style="width: 100%; height: 100%">
							...
							</label> <br> <label>Contato : ${censec.contato} </label> <br>
							<label>Status : ${censec.status} </label> <br> <label>UF
								: ${censec.uf} </label> <br> <label>Municipio :
								${censec.municipio} </label> <br> <label>Cartorio :
